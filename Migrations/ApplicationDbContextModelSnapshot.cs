...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdmissionSystem.Models.AdmissionApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AdmissionSystem.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AdmissionSystem.Models.EducationProgram", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AdmissionSystem.Models.AdmissionApplication", b =>
                {
                    b.HasOne("AdmissionSystem.Models.EducationProgram", "Program")
                        .WithMany("Applications")
                        .HasForeignKey("ProgramId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AdmissionSystem.Models.ApplicationUser", "User")
                        .WithMany("Applications")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AdmissionSystem.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
